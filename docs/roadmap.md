...
SQLite, and PostgreSQL. Graph constraints are content-addressed and produce durable queryable
observations; atomic enforcement is the next constraint milestone. Command receipts are atomically
...
- Next: opt-in transaction enforcement with explicit interval semantics and atomic absence/phantom
  protection. Observation mode remains available for migrations and audit.

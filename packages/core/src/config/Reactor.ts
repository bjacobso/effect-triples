...
const registerInto = (
  ...
  const evaluation = Evaluate.evaluate(expr, env.world, env.clock, env.catalog, env.subject);
...
export const answer = (reactor: Reactor, key: string): Evaluate.Evaluation | undefined =>

...
const TYPE_DOMAIN = "config-graph/type";
...
export const struct = (
  fields: Readonly<Record<string, StructField>>
): Struct => ({ _tag: "Struct", v: 1, fields });
...
export const union = (members: ReadonlyArray<TypeExpr>): TypeExpr => {
  ...
  return distinct.length === 1
    ? distinct[0]
    : { _tag: "Union", v: 1, members: distinct };
};
